...
export const webProjects: Project[] = [
  {
    title: "Job Application Tracker (Full Stack Web & Mobile)",
    description: "A full-stack Job Application Tracker developed for Web and Mobile platforms. Users can securely register and log in, manage job applications, track application status, search and filter records, edit application details, and delete applications. The web application is built with React, TypeScript, Vite, and Tailwind CSS. Both Web and Mobile applications use the same Node.js and Express.js backend, JWT authentication, and MongoDB Atlas database. The backend is deployed on Render and the web application is deployed on Vercel.",
