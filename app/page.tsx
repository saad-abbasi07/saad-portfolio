...
const mlProjects = [
  // ── 1. Customer Churn Intelligence (top — end-to-end deployed ML project) ──
  {
    ...
    description: "An end-to-end Machine Learning project that predicts whether a customer is likely to churn. Covers the complete workflow from ML model development and feature preprocessing to API development and cloud deployment. The API accepts customer information and returns a churn prediction with its probability.",
    technologies: ["Python", "Machine Learning", "FastAPI", "REST API", "Swagger", "Render"],
    github: "https://lnkd.in/dBeYXP5w",
    image: "/images/projects_images/customer-churn-intelligence.png",
    featured: true,
    links: [
      { label: "GitHub", url: "https://lnkd.in/dBeYXP5w", type: "github" },
      { label: "Live API / Swagger", url: "https://lnkd.in/dCRg_ZUT", type: "api" }
    ]
  },
  {
            ...
            <div className="container mx-auto h-full flex items-center px-8 sm:px-12 md:px-16 lg:px-24">
              ...
              theme === 'dark' ? 'bg-gray-800/70 md:bg-transparent' : 'bg-white/70 md:bg-transparent'
                ...
                <button 
                  ...
                  onClick={() => {
                    if (slide.action === "cv") {
                      window.open('/myResume/Saad_s_Resume.pdf', '_blank');
        ...
        <div className="max-w-6xl">
          ...
          <div className="border-l-2 border-red-500 ml-4 pl-8 space-y-12">
            <TimelineItem 
              ...
              desc="Worked on Machine Learning, Deep Learning, and Data Analysis projects. Applied data preprocessing, model training, and evaluation techniques. Contributed to AI/ML solutions and technical workflows. Recognized with the Best Intern Award (DHC-471) for outstanding skills and significant contributions throughout the program." 
            />
            <TimelineItem 
              icon={<FiBriefcase className="bg-yellow-600 text-white"/>} 
              date="Jan. 2026 – Mar. 2026" 
              title="Technical Mentor / Instructor" 
              sub="Digital Dreams Academy & Software House" 
              desc="Mentored interns in web development and programming. Guided students through practical coding projects and technical problem-solving. Conducted hands-on sessions and provided code reviews and technical support." 
            />
            <TimelineItem 
